...
public class NocalhostWindow implements Disposable {
    ...
    private void init() {
        ...
        emptyText.appendLine("Get started with Starship by connecting to a Kubernetes cluster.");
        ...
        emptyText.appendLine("Connect to Starship server", SimpleTextAttributes.LINK_ATTRIBUTES,
    ...
    private void setToolbar() {
        ...
        ActionToolbar actionToolbar = ActionManager.getInstance().createActionToolbar("Starship.Toolbar", actionGroup, true);
